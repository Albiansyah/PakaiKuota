...
const groups = [
  ...
  { label: "Konfigurasi", items: [{ href: "/admin/newapi-config", label: "NewAPI config", icon: Settings }, { href: "/admin?tab=models", label: "Model & pricing", icon: BarChart3 }, { href: "/admin/token-packages", label: "Token packages", icon: Package }] },
