    ...
    <Container size="xs" className="py-12">
      <Card className="bg-[var(--bg-surface)] border-[var(--border-color)]">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-left">{t("nav.login")}</CardTitle>
            <CardDescription className="text-left">Masukkan email dan password untuk masuk</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <Button variant="outline" className="w-full gap-2" onClick={handleGoogleLogin} disabled={googleLoading}>
              ...
              {googleLoading ? t("common.loading") : "Masuk dengan Google"}
            </Button>
          ...
          <CardFooter className="flex flex-col gap-4">
            <p className="text-sm text-[var(--text-secondary)]">
              Lupa password? <Link href="/forgot-password" className="text-[var(--accent-text)] hover:underline">Reset</Link>
            </p>
            <p className="text-sm text-[var(--text-secondary)]">
              Belum punya akun? <Link href="/register" className="text-[var(--accent-text)] hover:underline">{t("nav.register")}</Link>
            </p>
          </CardFooter>
        </Card>
    </Container>
